...
RSpec.describe RegionsController, type: :controller do
  let(:region) {
    FactoryGirl.create(:valid_region)
  }
  ...
  describe "PUT #update" do
    context "with valid params" do
      let(:new_attributes) {
        FactoryGirl.attributes_for(:valid_region, title_en: "new english title")
      }
      ...
      it "updates the requested region" do
        ...
        region.reload
        expect(assigns(:region).title_en).to eq "new english title"
      end
