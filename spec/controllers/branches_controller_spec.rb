...
RSpec.describe BranchesController, type: :controller do
  ...
  let(:branch) {
    FactoryGirl.create(:valid_branch)
  }
  ...
  describe "POST #create" do
    ...
    context "with invalid params" do
      it "assigns a newly created but unsaved branch as @branch" do
        post :create, {:branch => invalid_attributes}, valid_session
        expect(assigns(:branch)).to be_a_new(Branch)
      end
  ...
  describe "PUT #update" do
    context "with valid params" do
      let(:new_attributes) {
        FactoryGirl.attributes_for(:valid_branch, address_en: "new addr")
      }

      it "updates the requested branch" do
        
        put :update, {:id => branch.to_param, :branch => new_attributes}, valid_session
        branch.reload
        expect(assigns(:branch).address_en).to eq "new addr"
      end
    ...
    context "with invalid params" do
      it "assigns the branch as @branch" do
        ...
        put :update, {:id => branch.to_param, :branch => invalid_attributes}, valid_session
        expect(assigns(:branch)).to eq(branch)
      end
