var App = function () {
	...
	var handleDataTables = function () {
				...
				// ,"oTableTools": {
					// "aButtons": [
						...
						// {
							...
							// "sButtonText": "Email Selected",
							// "fnClick": function ( nButton, oConfig, oFlash ) {
								// alert( 'Mouse click Email Selected' );
							// }
						// },
						// {
							// "sExtends":    "print",
		...
		$("#datatable2 tbody tr").click(function (e) {
			if (! $(e.target).is("input[type='checkbox'],.btn,i") ) {
