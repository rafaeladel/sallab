class BannersController < ApplicationController
  ...
  def create
    ...
    @banner.gallery = SevenGallery::Gallery.new({title: "#{@banner.banner_type}_banner_gallery"})
  ...
  private
    ...
    def banner_params
      permitted = Banner.globalize_attribute_names + [:image, :banner_type]
      params[:banner].permit(*permitted)
    end
end
